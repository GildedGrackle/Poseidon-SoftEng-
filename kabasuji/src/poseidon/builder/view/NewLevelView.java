...
public class NewLevelView extends JPanel implements IBuilderScreen
{
	 ...
	 * Create the panel.
	 */
	public NewLevelView(LevelBuilderView view)
	{
		application = view;
	...
	public void initialize()
	{
		...
		newPuzzleButton.addActionListener(new MakePuzzleController(application));
		add(newPuzzleButton);
		...
		newLightningButton.addActionListener(new MakeLightningController(application));
		...
		newReleaseButton.addActionListener(new MakeReleaseController(application));
