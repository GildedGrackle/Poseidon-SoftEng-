...
/**
 *  Creates a new Lightning Level and displays it on the screen.
 *  
 *  The new Level has a 12x12 Board consisting entirely of LightningSquares.
 *  The Timer is set to a default of 60 seconds.
...
public class MakeLightningController implements ActionListener
{
	...
	// Create new Level and LevelContainer
		...
		for(int i = 0; i < Board.MAXROWS; i++)  // Fill newPlayArea with empty PuzzleSquares
		{
			...
			{
				newPlayArea[i][j] = new LightningSquare(false);
			}
		}
		...
		LevelContainer newContainer = new LevelContainer("newLightning", 3, 0, newLevel, 0);  // TODO use correct "inGame" input
